...
public class HanoiPole : MonoBehaviour
{
    ...
    // The event that will be called upon
    private UnityEvent _onStackDisc = new UnityEvent();
    ...
    /// <summary>
    /// Registers a listener on the OnStackDisc Event
    /// </summary>
    /// <param name="p_callback">The function callback to be registered</param>
    public void RegisterOnStackListener(UnityAction p_callback)
    {
        _onStackDisc.AddListener(p_callback);
    }
